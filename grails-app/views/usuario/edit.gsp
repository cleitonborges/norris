                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="access"><g:message code="usuario.access.label" default="Access" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: usuarioInstance, field: 'access', 'errors')}">
                                    <g:select name="access" from="${norris.Perfil.list()}" multiple="yes" optionKey="id" size="5" value="${usuarioInstance?.access*.id}" />
                                </td>
                            </tr>
