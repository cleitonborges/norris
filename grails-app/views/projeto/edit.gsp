                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="clientes"><g:message code="projeto.clientes.label" default="Clientes" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: projetoInstance, field: 'clientes', 'errors')}">
                                    <g:select name="clientes" from="${norris.Cliente.list()}" multiple="yes" optionKey="id" size="5" value="${projetoInstance?.clientes*.id}" />
                                </td>
                            </tr>
